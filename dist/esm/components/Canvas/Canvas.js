...
var Canvas = function Canvas(props) {
  var pan = props.pan,
      ...
      rest = _objectWithoutProperties(props, ["pan", "onPanChange", "zoom", "onZoomChange", "maxZoom", "minZoom", "zoomOnWheel", "inertia", "zoomResetOnDblClick", "ElementRenderer", "GridRenderer", "debug", "className", "children"]);
